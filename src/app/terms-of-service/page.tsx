    ...
    return (
        <div className="min-h-screen bg-[#f9fafa]">
            ...
            <div className="max-w-5xl mx-auto px-4 py-8 text-primary text-[18px] font-normal leading-[25px] mb-5">
                ...
                <p className="mb-4">
                    Welcome to walltik.com (hereinafter, the "Website") owned and managed by Walltik LLC., a limited liability company incorporated under the laws of the state of Israel (hereinafter, “WallTik”), “We” or “Us”).
                </p>
                ...
                By registering for and using the services provided on the WallTik Website, you acknowledge and agree that Walltik LLC. (and its affiliates, licensors, and partners where applicable) retains all ownership rights, title, and interest in and to all intellectual property relating to the Website and the services offered, including but not limited to:
                <p className="mb-4 ms-3">
                ...
                <p className="mb-4 ms-3">
                    The WallTik name, logo, and other trademarks displayed on the Website (whether registered or not) are the property of Walltik LLC..
